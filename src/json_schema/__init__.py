from .preprocess_json_schema import AUXILIARY_EXAMINATION_JSON_SCHEMA, PERSONAL_HISTORY_JSON_SCHEMA, SYMPTOM_JSON_SCHEMA, DIAGNOSIS_JSON_SCHEMA, TREATMENT_JSON_SCHEMA
