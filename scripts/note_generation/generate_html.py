...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', default='Combined_Chats_5_Pages.html', help='输出 HTML 文件名')
    ...
    if args.input_dir:
        ...
        if not json_paths:
            ...
            print(f"找到 {len(json_paths)} 个 JSON 文件，正在合并到 {args.output_file}...")
            process_multiple_jsons_to_single_html(json_paths, args.output_file)
    else:
        ...
        process_multiple_jsons_to_single_html(my_json_files, args.output_file)
